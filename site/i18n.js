...
export const STRINGS = {
  en: {
    ...
    "nav.limits": "Limits",
    "nav.scale": "Scale",
    "nav.cta": "Measure a text",
    "hero.measure": "Measure a text",
    "hero.source": "Read the source",
    "hero.version": "TypeScript \u00b7 zero dependencies \u00b7 61 tests",
    "card.1t": "Nineteen features, one function each",
    "card.1b": "Sentence shape, vocabulary, word classes, punctuation, layout. Every one is a plain descriptive statistic with no direction and no weight, because a feature that knows which way is bad has an argument built into it the caller cannot see.",
    "card.2t": "The profile is statistics, not texts",
    "card.2b": "It holds the mean, the spread and three percentiles per feature across the reference corpus. Not the corpus. Point the build script at ten of your own reports and the eleventh gets measured against your register instead of against dissertations.",
    "card.3t": "No verdict, by design",
    "card.3b": "There is no function that returns the distance on its own. A summary number travelling without its breakdown is the thing this library is an alternative to, and an API that made it convenient would get used that way.",
    "limits.statement": [
      "It cannot tell you ",
      ["who wrote this", true],
      ". A large distance is not evidence of anything. It is a reason to read the nineteen numbers underneath it."
    ],
    "limits.note": "Detectors of this kind produce false positives unevenly. Writing by non-native speakers is flagged far more often, and students have been accused on the strength of exactly this sort of number. It does not support that, and neither does its author.",
    "foot.aboutHead": "stylo",
    "foot.about": "Transparent stylometric measurement. Nineteen features against a measured corpus, in English and German.",
    "foot.projectHead": "Project",
    "foot.readme": "README",
  ...
  de: {
    ...
    "nav.scale": "Skala",
    "nav.cta": "Text messen",
    "hero.measure": "Text messen",
    "hero.source": "Quelltext ansehen",
    "hero.version": "TypeScript \u00b7 keine Abh\u00e4ngigkeiten \u00b7 61 Tests",
    "card.1t": "Neunzehn Merkmale, je eine Funktion",
    "card.1b": "Satzbau, Wortschatz, Wortklassen, Zeichensetzung, Aufbau. Jedes ist eine schlichte deskriptive Statistik ohne Richtung und ohne Gewicht, denn ein Merkmal, das wei\u00df, welche Seite die schlechte ist, hat ein Argument eingebaut, das der Aufrufende nicht sieht.",
    "card.2t": "Das Profil sind Statistiken, keine Texte",
    "card.2b": "Es enth\u00e4lt Mittelwert, Streuung und drei Perzentile pro Merkmal \u00fcber das Referenzkorpus. Nicht das Korpus. Das Build-Skript auf zehn eigene Berichte richten, und der elfte wird gegen das eigene Register gemessen statt gegen Dissertationen.",
    "card.3t": "Kein Urteil, mit Absicht",
    "card.3b": "Es gibt keine Funktion, die nur den Abstand zur\u00fcckgibt. Eine zusammenfassende Zahl ohne ihre Herleitung ist genau das, wozu diese Bibliothek die Alternative sein soll, und eine API, die das bequem macht, w\u00fcrde auch so benutzt.",
    "limits.statement": [
      "Es kann nicht sagen, ",
      ["wer das geschrieben hat", true],
      ". Ein gro\u00dfer Abstand ist kein Beweis. Er ist ein Grund, die neunzehn Zahlen darunter zu lesen."
    ],
    "limits.note": "Detektoren dieser Art erzeugen falsch positive Ergebnisse, und zwar ungleich verteilt. Texte von Nicht-Muttersprachlern werden deutlich h\u00e4ufiger auff\u00e4llig, und Studierende sind auf Basis genau solcher Zahlen beschuldigt worden. Die Zahl tr\u00e4gt das nicht, und ihr Autor auch nicht.",
    "foot.aboutHead": "stylo",
    "foot.about": "Transparente stylometrische Messung. Neunzehn Merkmale gegen ein gemessenes Korpus, auf Deutsch und Englisch.",
    "foot.projectHead": "Projekt",
    "foot.readme": "README",
